...
model = struct('SPoC_lambda',num2cell(lambda'),'SPoC_p_value',num2cell(p_value),'SPoC_signal',mat2cell(X_var,sz(3),ones(1,l)));
EEG = SPoC_store_new_weights( EEG , W', eye(EEG.nbchan) ,1:EEG.nbchan ,'SPoC',model);
EEG.SPoC_z = z;
